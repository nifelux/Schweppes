...
function webhookTransactionReference(payload) {
  ...
  return payload?.transaction_ref || payload?.transactionReference || payload?.trx_id || payload?.transaction_id ||
    data.transaction_ref || data.transactionReference || data.trx_id || data.transaction_id || data.ref_trx ||
    payment.transaction_ref || payment.transactionReference || payment.trx_id || payment.transaction_id || payment.ref_trx || null;
}
